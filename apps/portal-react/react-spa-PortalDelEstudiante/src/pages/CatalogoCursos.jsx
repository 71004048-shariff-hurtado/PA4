...
/*
COMENTARIOS DEL COMPONENTE CatalogoCursos:

Requerimientos Cumplidos:
- ✓ Visualizar catálogo de cursos (función principal)
- ✓ Filtrar por categoría
- ✓ Filtrar por modalidad
- ✓ Búsqueda de cursos
- ✓ Ordenamiento (popular, valoración, reciente, precio)
- ✓ Usa useState para mantener estado de filtros
- ✓ Usa useEffect para aplicar filtros dinámicamente
- ✓ Componente funcional bien estructurado
- ✓ Reutilización de TarjetaCurso

Acceso a datos:
- Mediante Context API (useCursos hook)
- Sin props drilling
- Datos actualizados reactivamente
*/
